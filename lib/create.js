...
var fs = require('fs');
// 不生成的文件
var miscFiles = ['.DS_Store'];

const createRootDir = function createRootDir(rootDir) {
 ...
 */
const copyDir = function (_copyDir) {
  function copyDir(_x, _x2) {
...
exports.init = function (path, dist, rootDir) {
